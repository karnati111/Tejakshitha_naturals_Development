  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg relative z-10 space-y-6">
        ...
        {/* Verification & Test Walkthrough Specifications Banner Button */}
        {onOpenWalkthrough && (
          <button
            onClick={onOpenWalkthrough}
            id="btn-login-open-walkthrough"
            type="button"
            className="w-full p-3.5 rounded-2xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-200 text-xs transition flex items-center justify-between group cursor-pointer shadow-lg"
          >
            <div className="flex items-center space-x-3 text-left">
              ...
              <div>
                <div className="font-bold text-white text-xs flex items-center space-x-1.5">
                  ...
                  <span className="px-1.5 py-0.5 rounded bg-amber-500/30 text-[10px] font-mono text-amber-300 font-bold">
                    13 Specs
                  </span>
                </div>
                <p className="text-[11px] text-amber-300/80 mt-0.5">
                  Step-by-step test instructions, ABAC matrix &amp; QA checklist
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-1 text-amber-300 font-semibold group-hover:translate-x-0.5 transition-transform shrink-0 ml-2">
