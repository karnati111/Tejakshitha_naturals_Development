...
export const ProductionProcurementCard: React.FC<ProductionProcurementCardProps> = ({
  ...
  return (
    <div
      ...
      className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden w-full min-w-0 max-w-full"
    >
      {/* Top Banner with Production Incharge Badge */}
      <div className="px-4 sm:px-5 py-3.5 sm:py-4 bg-slate-900 text-white border-b border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 w-full min-w-0">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
            <span className="px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-wider bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 shrink-0">
